...
class UsersRoute implements Routes {
  ...
  private initializeRoutes() {
    ...
    this.router.get(`${this.path}/get-users`, this.usersController.getAllUser);
    this.router.get(`${this.path}/get-user-dtls/:userId`, [validate(UsersValidation.getUserData)], this.usersController.getUserById);
